...
class BMX160:
    ...
    def __init__(self, bus):
        ...
        print("init")
        self.i2c = machine.I2C(0, sda=machine.Pin(16), scl=machine.Pin(17))  
        self.i2c_addr = 0x68 
        time.sleep(0.16)
    ...
    def set_magn_conf(self):
        ...
        #Prepare MAG_IF[1-3] for mag_if for data mode
    ...
    def write_bmx_reg(self, register, value):
       ...
       # self.i2cbus.write_byte_data(self.i2c_addr, register, value)
        self.i2c.writeto_mem(self.i2c_addr,register,bytearray([value]))
    ...
    def read_bmx_reg(self, register):
        '''!
          ...
          @return data
        '''
        return self.i2c.readfrom_mem(self.i2c_addr, register, 23)
    ...
    def scan(self):
        ...
        '''
        print("BMX160 sensor found on the I2C bus!") 
        try:  
            devices = self.i2c.scan() 
            if 0x69 | 0x68 in devices:
                print("BMX160 sensor found on the I2C bus!") 
            return True
        except:
            print("I2C init fail")
            return False
    # def AdvancedSelfTest(self):
    #     # 1. Set sleep mode
    #     # 2. Disable X, Y axis
    ...
    #     # 9. Calculate difference between the two compensated field values. This difference should be
    #     # around 200 μT with some margins
    #     # 10. Perform a soft reset of manually restore desired setting
    #     CMD_REGISTER = 0x7E
    #     MAG_IF_REGISTER = 0x4C

    #     # Data values
    #     NORMAL_MODE_CMD = 0x19
    #     MAG_MANUAL_EN_BIT = 0x01

    #     # Put magnetometer interface into normal mode
    #     self.write_bmx_reg(CMD_REGISTER, NORMAL_MODE_CMD)

    #     # Configure magnetometer interface into setup mode
    #     mag_if_value = self.read_bmx_reg(MAG_IF_REGISTER)
    #     mag_if_value = int.from_bytes(mag_if_value, byteorder='big')

    #     # Perform bitwise OR operation
    #     mag_if_value |= MAG_MANUAL_EN_BIT

    #     # Convert integer back to bytes
    #     mag_if_value = mag_if_value.to_bytes(4, byteorder='big')
    #     self.write_bmx_reg(MAG_IF_REGISTER, mag_if_value)
    ...
    #     # Put the magnetometer into sleep mode
    #     self.write_bmx_reg(self._BMX160_MAGN_IF_3_ADDR, 0x01)
    #     self.write_bmx_reg(self._BMX160_MAGN_IF_2_ADDR, 0x4B)
